...
export const Project: React.FC<ProjectProps> = ({
  ...
  return (
    <div className="flex flex-col items-center gap-[50px]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[50px] lg:gap-[80px] place-items-center justify-center w-full">
        {videoUrl ? (
          ...
          src && (
            <div className="w-full max-w-[280px] justify-self-center order-2 lg:order-1">
              <Image
                src={src}
                alt="project image"
                width={280}
